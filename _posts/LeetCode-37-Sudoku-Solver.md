...
we can apply backtracking method to solve this problem, firstly, iteratively visit every field of which value is '.' and get all possibile inputs that can be input into.
